...
Generated on: The current date is: Thu 09/25/2025 
...
```json
{
  "E:\\videoes\\ApSlayz Rage Compilation Part 1 [Q3z2LA9vGyU].webm": 1,
  "E:\\videoes\\ApSlayz Rage Compilation Part 4 [uVNhUyPA5Gs].webm": 2,
  "E:\\videoes\\Dellor Rage Compilation Part 1.mp4": 0
}
```
...
class ExplorerWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.video_widget.setAttribute(qt.WidgetAttribute.WA_PaintOnScreen, True)
    ...
    def showEvent(self, event):
        ...
        self._player.init(window=self.video_widget.winId())
        QTimer.singleShot(1, lambda: self._player.set_window(self.video_widget.winId()))
```
...
#### File: `files-rc\vlc_audio_filter.py`
...
#### File: `files-rc\vlc_video_player.py`
...
class PlayerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Use VLCVideoPlayer instead of MPVVideoPlayer
    ...
    def _init_player(self):
        try:
            self.player.init(window=self.video_display.winId())
            print(self.video_display.winId(), type(self.video_display.winId()))
    ...
    def _populate_filters(self):
        # Only add VLCEqualizerFilter for VLC backend
        self.available_filters = {
            "Equalizer": av_play.VLCEqualizerFilter
        }
        for name, filter_class in self.available_filters.items():
            try:
                ...
                for param_name, default_value in params.items():
                    param_info = instance.info.get("vlc_param_map", {}).get(param_name)
                    if param_info:
                        ...
                        if p_type == str and len(p_range) > 0:
                            ...
                            # Provide sensible defaults for float/int
                            config[param_name] = (p_type.__name__, (*p_range, 1, default_value))
