...
os.environ["MPV_LIB_PATH"] = os.path.join(get_app_path(), "lib")
...
def main():
    ...
    try:
        ...
        if len(cli_args) > 1:
            ...
            app_instance.focus_window("Photon Snapshot")
        ...
        log_error("Critical error in main application", )
        exit_code = 1
