...
class ExplorerWidget(QWidget):
    ...
    def __init__(self, user_db:UserFiles, **kw):
        ...
        self._explorer:Explorer = Explorer(extensions)
    ...
    def _setup_ui(self):
        ...
        self.explorer_view = ExplorerView(self._explorer, self._player, self, **self._callbacks)
    ...
    def volumeChange(self, value):
        if self._instance is not None:
            self._instance.set_volume(value)
             ...
             if self._instance is not None: self._instance.set_volume(value)
