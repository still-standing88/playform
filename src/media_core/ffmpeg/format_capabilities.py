...
AUDIO_FORMATS: dict[str, AudioFormatCapability] = {
    ...
    "m4b": AudioFormatCapability(
        id="m4b",
        label="M4B / Audiobook (AAC in MP4 container)",
        extension="m4b",
        encoder="aac",
        encoder_label="Native AAC",
        lossless=False,
        ...
        sample_rates=_COMMON_SAMPLE_RATES,
        default_sample_rate=44100,
        bitrates_kbps=[32, 48, 64, 80, 96, 112, 128, 160, 192],
        default_bitrate_kbps=64,
        notes="Audiobook container; chapters/cover art are added separately by media_core.m4b_tools.",
        codec_options=[
            CodecOption("profile", "Profile", "choice", "profile",
                        choices=["aac_low", "mpeg2_aac_low", "aac_ltp"], default="aac_low"),
            CodecOption("aac_coder", "Coding Method", "choice", "aac_coder",
