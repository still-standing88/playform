...
class ExtractorUI(QWidget):
    ...
    def _build_ui(self):
        ...
        self.input_path_edit.setAccessibleName(_("Source file path"))
        self.browse_button = QPushButton(_("Browse..."), self)
        self.browse_button.clicked.connect(self._browse_input)
        input_label = QLabel(_("Source File:"))
        input_label.setBuddy(self.input_path_edit)
        ...
        self.start_time_edit.setAccessibleName(_("Start time"))
        self.end_time_edit = QLineEdit(self)
        self.end_time_edit.setPlaceholderText(_("e.g. 00:01:30 or 90 (optional)"))
        self.end_time_edit.setAccessibleName(_("End time or duration"))
        start_label = QLabel(_("Start Time:"))
        start_label.setBuddy(self.start_time_edit)
        end_label = QLabel(_("End Time / Duration:"))
        end_label.setBuddy(self.end_time_edit)
        trim_row.addWidget(start_label)
        trim_row.addWidget(self.start_time_edit)
        trim_row.addWidget(end_label)
