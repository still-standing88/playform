...
class CoverTab(QWidget):
    ...
    def _build_ui(self):
        ...
        self.book_path_edit.setAccessibleName(_("Audiobook file path"))
        ...
        self.extract_output_edit.setAccessibleName(_("Cover image output path"))
        ...
        self.cover_image_edit.setAccessibleName(_("Cover image path"))
        ...
        self.apply_output_edit.setAccessibleName(_("Output audiobook file path"))
    ...
    def _on_finished(self, success: bool, error: str):
        ...
        _announce(_("Done") if success else _("Cover operation failed"))
